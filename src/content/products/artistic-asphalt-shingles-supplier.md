...
hero_description: "Unique and creative hexagonal or fish-scale asphalt shingles for architectural roofing. High flexibility for complex roof geometries with premium aesthetic appeal."

hero_tags:
  - "Artistic Designs"
  - "Hexagonal / Fish-Scale"
  - "Full Back Adhesive"
  - "Creative Roofing"
  - "Custom Colors"
...
spec_table:
  - label: "Product Type"
    value: "Hexagonal / Fish-Scale Artistic Shingles"
  - label: "Material"
    value: "Fiberglass Mat & Modified Bitumen & Ceramic Granules"
  - label: "Dimensions"
    value: "1000mm x 333mm (Standard)"
  - label: "Thickness"
    value: "2.7mm - 3.2mm"
  - label: "Weight"
    value: "Approx. 24kg - 27kg / bundle"
  - label: "Adhesive"
    value: "Enhanced full-width self-sealing glue"
  - label: "Standard"
    value: "GB/T 20474-2006 / ASTM D3462"
...
Manufactured with high-performance fiberglass mats and ceramic granules, they combine beauty with professional-grade waterproofing. As a specialist manufacturer, we provide the flexibility to supply various shapes and colors for custom project needs.
