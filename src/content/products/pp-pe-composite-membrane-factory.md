---
title: "Polyethylene Polypropylene Polymer PP Waterproof Membrane"
...
hero_description: "Factory-supplied multi-layer high-polymer PP/PE composite waterproofing membrane. Features high-strength polypropylene fleece reinforcement for superior bonding and breathability."
...
spec_table:
  - label: "Product Type"
    value: "Polyethylene Polypropylene (PP/PE) Composite Membrane"
  - label: "Standard"
    value: "GB18173.1-2012"
  - label: "Structure"
    value: "Multi-layer with PP fleece, EVA, PE, and auxiliary adhesive layers"
  - label: "Thickness"
    value: "0.5mm, 0.8mm, 1.0mm, 1.2mm, 1.5mm"
  - label: "Weight"
    value: "200g/mÂ² to 1000g/mÂ²"
  - label: "Width"
    value: "1m, 1.15m, 1.2m"
  - label: "Length"
    value: "80m - 100m/roll (Customizable)"
  - label: "Color"
    value: "Gray, White, Red, Green, Blue, or Customized"
  - label: "Application"
    value: "Roofing, basement, bathroom, tunnels, landfills, reservoirs"
...
technical_data:
  - label: "Tensile Strength (23Â°C)"
    unit: "N/cm"
    standard: "GB18173.1 / FS2"
    requirement: "â‰?60"
    value: "Qualified (75+)"
  - label: "Tensile Strength (60Â°C)"
    unit: "N/cm"
    standard: "GB18173.1 / FS2"
    requirement: "â‰?30"
    value: "Passed"
  - label: "Breaking Elongation (-20Â°C)"
    unit: "%"
    standard: "GB18173.1 / FS2"
    requirement: "â‰?300"
    value: "350%+"
...
loading_data:
  ...
  - label: "Container Load"
    value: "Approx. 15,000â€?0,000 mÂ² per 20FT container"
...
Perfect for bathrooms, basements, and large scale infrastructure, this membrane is favored for its wet-base compatibility and ability to bond directly with cement-based mortars. As a specialist manufacturer, Tianyuan supports full OEM customization, providing tailored thicknesses, roll weights, and colors for global building material distributors and contractors.
