...
quick_facts:
  - title: "Polyester-Reinforced Core"
    icon: "shield"
    text: "Internal scrim delivers high tensile strength and puncture resistance for wind uplift and foot traffic."
  - title: "Monolithic Hot-Air Welding"
    icon: "flame"
    text: "Fused seams become stronger than the membrane itself — no adhesives, zero leak paths."
  - title: "Advanced UV & Weather Resistance"
    icon: "sun"
    text: "Formulated to resist embrittlement from decades of sun exposure (-25°C to 80°C)."
  - title: "Root & Chemical Resistance"
    icon: "flask"
    text: "Inherently resists root penetration and common industrial chemicals without additional barriers."
  - title: "Total System Supply"
    icon: "package"
    text: "Full accessory ecosystem: prefabricated corners, fasteners, and welding technical support."
