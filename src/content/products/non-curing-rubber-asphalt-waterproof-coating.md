---
title: "Non-Curing Rubber Asphalt Waterproof Coating Manufacturer | Self-Healing Composite System | Wholesale"
displayName: "Non-Curing Rubber Coating"
category: "waterproof-coatings"
featured: true
order: 50
meta_description: "Factory-direct non-curing rubber asphalt waterproof coating. JC/T 2428-2017 certified, ≥99% solid content, permanently viscous, self-healing, anti-water channeling. Hot-applied composite system with SBS membrane. OEM & free sample. Get a quote!"
...
technical_scope: "Non-Curing Rubber Asphalt / JC/T 2428-2017 / 25kg Drum (Representative Configuration)"
technical_disclaimer: "Values shown apply to the stated product configuration. Other packaging sizes and formulations may have different performance values. Request the corresponding TDS and batch test report before specification or procurement."

gallery:
  - image: "https://img.tyuanwaterproof.com/products/non-curing-rubber-asphalt-coating-v2.webp"
    title: "Non-Curing Rubber Asphalt Coating"
    alt: "Non-curing rubber asphalt waterproof coating drum packaging black viscous"
  - image: "/placeholder.webp"
    title: "Production Line"
    alt: "Non-curing rubber asphalt waterproof coating factory production line"
...
spec_table:
  ...
  - label: "Construction Speed"
    value: "Up to 115 m²/h via continuous spray equipment"
  - label: "Packaging"
...
technical_data:
  ...
  - label: "Solid Content"
    ...
    requirement: "≥ 98"
    value: "≥ 99"
  - label: "Adhesion — Dry Base"
    unit: "—"
    standard: "JC/T 2428"
    requirement: "100% cohesive failure"
    value: "100% cohesive failure"
  - label: "Adhesion — Wet Base"
    unit: "—"
    standard: "JC/T 2428"
    requirement: "100% cohesive failure"
    value: "100% cohesive failure"
  ...
  - label: "Low Temp Flexibility"
    unit: "°C"
    standard: "JC/T 2428"
    requirement: "-20°C — No fracture"
    value: "No fracture"
  - label: "Heat Resistance"
    unit: "°C"
    standard: "JC/T 2428"
    requirement: "65°C — No sliding, flowing, dripping"
    value: "Passed"
  - label: "Self-Healing"
    unit: "—"
    standard: "JC/T 2428"
  ...
  - label: "Oil Permeability"
    ...
    requirement: "≤ 2"
    value: "≤ 2"
  - label: "Heat Aging (70°C×168h) — Extensibility"
    unit: "mm"
    standard: "JC/T 2428"
    requirement: "≥ 15"
    value: "≥ 15"
  - label: "Heat Aging — Low Temp Flexibility"
    unit: "°C"
    standard: "JC/T 2428"
    requirement: "-15°C — No fracture"
    value: "No fracture"
  - label: "Acid Resistance (2% H₂SO₄)"
    unit: "—"
    standard: "JC/T 2428"
    requirement: "No appearance change, extensibility ≥15mm, mass ±2%"
    value: "Passed"
  - label: "Alkali Resistance (NaOH + Ca(OH)₂)"
    unit: "—"
    standard: "JC/T 2428"
    requirement: "No appearance change, extensibility ≥15mm, mass ±2%"
    value: "Passed"
  - label: "Salt Resistance (3% NaCl)"
    unit: "—"
    standard: "JC/T 2428"
    requirement: "No appearance change, extensibility ≥15mm, mass ±2%"
    value: "Passed"
  - label: "Stress Relaxation"
    unit: "%"
    standard: "JC/T 2428"
    requirement: "≤ 35 (untreated & heat-aged)"
    value: "≤ 35"
  - label: "Water Resistance"
    unit: "MPa"
    standard: "JC/T 2428"
    requirement: "0.6MPa — No water penetration"
...
loading_data:
  - label: "20FT Container (25kg drums)"
    value: "Approx. 630 drums / 15,750 kg (varies by pallet configuration)"
  - label: "Packaging Options"
    value: "20kg / 25kg metal drums — custom sizes available"
  - label: "Documentation"
    value: "TDS, MSDS, Packing List, Certificate of Origin"

downloads:
  - title: "Non-Curing Coating Technical Data Sheet (TDS)"
    description: "Complete JC/T 2428-2017 technical index with 16 performance parameters, heat aging data, and chemical resistance test results."
    type: "PDF"
    href: ""
  - title: "Composite System Installation Guide"
    description: "Full instructions covering heating, spray and trowel application, SBS membrane hot-bond and cold-bond composite, and quality acceptance procedures."
    type: "PDF"
    href: ""
...
It remains permanently viscoelastic — the same consistency on day one and year fifty. There is almost nothing to evaporate: ≥99% of what leaves the drum stays on the substrate as functional material.

**What this means in practice:** the coating never cracks from aging, never shrinks away from the concrete, and never becomes brittle from thermal cycling. When the building moves — and every building moves — a cured coating has to stretch to keep up. This coating doesn't stretch. It flows. The crack opens, the material around it shifts into the gap, and the waterproofing stays intact.
...
The coating is not meant to be the primary waterproofing layer. Its job is to bond the membrane to the concrete — permanently, with no gap between them.
...
- **Permanently soft.** No aging. No film shrinkage. No temperature-cycle fatigue.
- **Self-sealing punctures.** The material flows into damage sites under its own weight — no chemical reaction or manual repair needed.
- **The bond fails before the coating does.** 100% cohesive failure — the coating tears itself apart before it peels off the concrete. Both dry and wet substrates.
...
JC/T 2428-2017 compliant. Sixteen performance parameters on the TDS — request it with your inquiry.
