...
related_products:
  ...
  - title: "Butyl Sealing Tape"
    description: "Self-adhesive tape for joint sealing and detail waterproofing in wet areas."
    image: "https://img.tyuanwaterproof.com/products/butyl-tape.webp"
    href: "/products/butyl-rubber-waterproof-sealing-tape/"
...
faqs:
  ...
  - question: "Can I add water to the mixture?"
    answer: "Adding water is generally not recommended as it alters the polymer-to-cement ratio and can weaken the final waterproof film. Always stick to the specified A:B mixing ratio."
...
*   **Wet-Base "Magic"**: Unlike solvent-based coatings that require bone-dry substrates, our JS coating thrives on damp surfaces. It uses the moisture in the concrete to enhance its bond, significantly reducing waiting time after rainfall or concrete pouring.
*   **Grade Tailoring (I & II)**: We offer **Type I** for projects requiring maximum elongation (ideal for moving structures) and **Type II** for projects requiring higher tensile strength and bond power (ideal for rigid underground walls).
*   **Vertical Stability**: Our formula is engineered with high thixotropy, ensuring it stays exactly where you brush it. This prevents the "sagging" effect on bathroom walls and elevator pits, ensuring uniform protection.
...
*   **Structural Repair**: An excellent choice for moisture-proofing existing masonry walls and refurbishing old concrete structures.

Tianyuan Waterproof supports international contractors, engineering distributors, and OEM partners with reliable supply, comprehensive **TDS/MSDS documentation**, and site application guidance.
