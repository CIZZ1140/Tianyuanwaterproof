...
hero_description: "Time-tested organic asphalt saturated roofing felt. The essential secondary moisture barrier for residential pitched roofs, specifically designed for use under asphalt shingles."
...
spec_table:
  - label: "Product Type"
    value: "Asphalt Roofing Felt / Saturated Felt"
  - label: "Standards"
    value: "ASTM D226 (15#/30#), ASTM D4869 (15#/30#)"
  - label: "Material"
    value: "Organic fiber felt saturated with premium petroleum asphalt"
  - label: "Thickness"
    value: "0.5mm, 0.8mm"
  - label: "Weight Grade"
  ...
  - label: "Roll Width"
    value: "1m (36 inch)"
  - label: "Roll Area"
    value: "216 ft² / 432 ft² depending on type"
  - label: "Surface"
    value: "Talcum powder or fine sand to prevent sticking"
...
packaging:
  ...
  - title: "Vertical Storage"
    text: "Store rolls in an upright position in a dry, ventilated area below 45°C."
...
loading_data:
  - label: "Container Load"
    value: "Approx. 800 - 1,200 rolls per 20FT container"
...
Primarily used under asphalt shingles, this felt protects the roof deck during construction and provides a critical secondary layer of defense against weather throughout the roof's life. As a specialized manufacturer, Tianyuan supplies export-quality asphalt felt conforming to international ASTM standards, supporting B2B clients with customized roll specifications and private label services.
