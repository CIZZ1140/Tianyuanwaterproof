...
main_image: "https://img.tyuanwaterproof.com/products/bitumen-tape.webp"
image: "https://img.tyuanwaterproof.com/products/bitumen-tape.webp"

hero_description: "Professional cold-applied SBS rubberized bitumen sealing tape with aluminum foil protection. The ideal solution for roof flashing, pipe sealing, and quick waterproof repairs."
...
spec_table:
  - label: "Product Type"
    value: "Self-Adhesive Bitumen Flashing Tape"
  - label: "Material"
    value: "SBS rubberized asphalt compound with aluminum foil surface"
  - label: "Top Surface"
    value: "Reinforced Aluminum Foil / PE Film"
  - label: "Thickness"
    value: "1.0mm, 1.2mm, 1.5mm"
  - label: "Width"
    value: "5cm, 10cm, 15cm, 20cm, 30cm (Customizable)"
  - label: "Roll Length"
    value: "5m, 10m, 15m, 20m (Customizable)"
  - label: "Application"
    value: "Roof flashing, gutters, pipes, skylights, parapets"
  - label: "Service Temp"
    value: "-40°C to +80°C"
...
technical_data:
  - label: "Persistent Adhesivity"
    ...
    requirement: "≥ 20"
    value: "Passed"
  - label: "Heat Resistance (80°C)"
    unit: "h"
    standard: "Reference Standard"
    requirement: "2h"
    value: "No flow/blister"
...
packaging:
  ...
  - title: "Storage Condition"
    text: "Store horizontally in dry conditions between +5°C and +25°C in original packaging."
  - title: "OEM Labeling"
    text: "Custom roll sizes, private brand logos, and customized box designs available for B2B partners."

loading_data:
  - label: "Shelf Life"
    value: "12 Months from production date"
  - label: "Thickness Options"
    value: "1.0mm, 1.2mm, 1.5mm standard"
  - label: "OEM Support"
    value: "Full private label and packaging support"
...
Ideal for flashing, pipe joints, and emergency leak repairs, this versatile tape bonds effortlessly to concrete, metal, wood, and traditional roofing felts. As a direct factory supplier, Weifang Tianyuan supports global B2B clients with customized tape widths, lengths, and private label packaging to meet specific regional construction needs.
