...
hero_description: "Premium high-solid two-component epoxy floor coating for commercial and industrial interiors. Features superior self-leveling, wear resistance, and a seamless decorative finish."
...
spec_table:
  - label: "Product Type"
    value: "Epoxy Color Sand Self-Leveling Coating"
  - label: "Solid Content"
    value: "95% (High Solid Content)"
  - label: "Mixing Ratio"
    value: "1:2 (Curing Agent : Resin)"
  - label: "Surface Finish"
    value: "Seamless Decorative Finish"
  - label: "Wait Time"
    value: "12-16 hours for foot traffic"
  - label: "Full Cure"
    value: "7 days for maximum performance"
  - label: "Standard"
    value: "Eco-Friendly Interior Grade"
  - label: "Packaging"
    value: "20kg / 25kg Airtight Buckets"
...
loading_data:
  - label: "Dosage"
    value: "Approx. 1.0 - 1.2 kg/mÂ² per mm of thickness"
  - label: "Shelf Life"
    value: "12 Months in original unopened packaging"
  - label: "MOQ"
    value: "Standard factory minimum applies"
...
Favored for its exceptional wear resistance and hygiene, this coating is the preferred solution for offices, playgrounds, and commercial corridors. As a dedicated manufacturer, Tianyuan supports global importers and contractors with professional-grade epoxy paints, technical support, and full OEM customization to meet regional market standards.
