...
hero_description: "Professional-grade HDPE pre-applied waterproofing membrane for underground engineering. Forms a permanent chemical and mechanical bond with post-cast concrete to eliminate water channeling."
...
spec_table:
  - label: "Product Type"
    value: "Self-Adhesive Pre-Applied HDPE Membrane"
  - label: "Standard"
    value: "EN 13967 / GB/T 23457"
  - label: "Structure"
    value: "HDPE film + Polymer self-adhesive film + Protective layer"
  - label: "Thickness"
    value: "1.2mm, 1.5mm"
  - label: "Width"
    value: "1.0m or 2.0m"
  ...
  - label: "Lap Area"
    value: "70mm reserved synthetic adhesive lap area"
  - label: "Application"
    value: "Underground engineering, basements, foundations"
...
loading_data:
  ...
  - label: "Container Load"
    value: "Approx. 10,000–12,000 m² per 20FT container"
...
# Advanced Pre-Applied Waterproofing System

Self-adhesive pre-applied HDPE waterproof membrane is a high-performance solution engineered specifically for critical underground structures. By utilizing a high-density polyethylene film combined with a reactive polymer self-adhesive layer, it provides an impenetrable barrier that integrates directly with the concrete foundation.

Favored for its extreme puncture resistance and zero lateral water migration, this system is ideal for subways, deep basements, and civil infrastructure in high-water-table regions. As a dedicated manufacturer, Tianyuan provides EN-standard tested HDPE membranes with full OEM support and project-specific technical documentation.
